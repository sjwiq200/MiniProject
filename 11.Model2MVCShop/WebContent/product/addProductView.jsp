...
<body bgcolor="#ffffff" text="#000000">
	...
	<div class="navbar  navbar-default">
   	...
   	<div class="container">
		  ...
		  <div class="form-group">
			    <label for="files" class="col-sm-offset-1 col-sm-3 control-label">상품 이미지</label>
			    <div class="col-sm-4">
			      	<input multiple="multiple" type="file" class="form-control" id="files" name="files">
			    </div>
		  </div>
		  ...
		  <div class="form-group">
			    <label for="prodCount" class="col-sm-offset-1 col-sm-3 control-label">상품 개수</label>
			    <div class="col-sm-3">
			      	<input type="text" class="form-control" id="prodCount" name="prodCount" placeholder="상품 개수"> 
			    </div>
